...
public class BookShopDaoImpl implements BookShopDao {
	...
	public BookShopDaoImpl() throws Exception {
		...
		pst5 = cn.prepareStatement("insert into my_customers values(?,?,?,?,?,?,?)");
	...
	@Override
	public String doRegistration(Customer c) throws Exception {
		pst5.setInt(1 , c.getId());
		pst5.setDouble(2 , c.getRegAmount());
		pst5.setString(3 , c.getEmail());
		pst5.setString(4, c.getName());
		pst5.setString(5 , c.getPass());
		pst5.setDate(6, c.getRegDate());
		pst5.setString(7, c.getRole());
